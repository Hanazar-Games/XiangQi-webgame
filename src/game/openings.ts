import { Position, Move, Piece } from './types.js';
...
export class OpeningBook {
  private chosenOpening: OpeningMove[] | null = null;
  ...
  getMove(board: (Piece | null)[][], blackMoveCount: number): Move | null {
    if (!this.chosenOpening) return null;

export interface Theme {
  ...
  lineColor: string;
  riverText: string;
  pieceRed: { bg: string; text: string; border: string };
  pieceBlack: { bg: string; text: string; border: string };
  highlight: { select: string; lastMove: string; check: string; validMove: string };
}
...
export const ALL_THEMES: Theme[] = [CLASSIC_THEME, DARK_THEME, BLUE_THEME, INK_THEME];
